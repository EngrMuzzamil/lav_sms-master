...
class Mk extends Qs
{
    ...
    public static function getSubTotalTerm($st_id, $sub_id, $term, $class_id, $year)
    {
        ...
        $tex = 'tex'.$term;
        $sub_total = CustomFields::where($d)->select($tex)->get()->where($tex, '>', 0);
    ...
    public static function countStudents($exam_id, $class_id, $section_id, $year)
    {
        ...
        return CustomFields::where($d)->select('student_id')->distinct()->get()->count();
    }
    ...
    public static function getTermAverage($st_id, $term, $year)
    {
        ...
        $mk = CustomFields::where($d)->whereNotNull('tex3');
    ...
    public static function deleteOldRecord($st_id, $class_id)
    {
        ...
        $marks = CustomFields::where('my_class_id', '<>', $class_id)->where($d);
