...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function userIsMyChild($student_id, $parent_id)
    {
        ...
        return StudentCourseInfo::where($data)->exists();
    }

    public static function getSRByUserID($user_id)
    {
        return StudentCourseInfo::where('user_id', $user_id)->first();
    }
    ...
    {
        return StudentCourseInfo::where('my_parent_id', $parent_id)->with(['user', 'my_class'])->get();
    }
