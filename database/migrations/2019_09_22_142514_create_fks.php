...
class CreateFks extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('student_records', function (Blueprint $table) {
            ...
            $table->foreign('my_class_id')->references('id')->on('my_classes')->onDelete('cascade');
            $table->foreign('section_id')->references('id')->on('sessions')->onDelete('cascade');
            $table->foreign('my_parent_id')->references('id')->on('users')->onDelete('set null');
            $table->foreign('dorm_id')->references('id')->on('faculty')->onDelete('set null');
        });
        ...
        Schema::table('marks', function (Blueprint $table) {
            ...
            $table->foreign('my_class_id')->references('id')->on('my_classes')->onDelete('cascade');
            $table->foreign('section_id')->references('id')->on('sessions')->onDelete('cascade');
            $table->foreign('subject_id')->references('id')->on('department')->onDelete('cascade');
            $table->foreign('exam_id')->references('id')->on('exams')->onDelete('cascade');
            $table->foreign('grade_id')->references('id')->on('degree')->onDelete('set null');
        });
